...
var XAjaxClass = (function () {
    ...
    XAjaxClass.prototype.get = function (url, params, headers) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request({ url: url, params: params, method: HttpMethod.GET, headers: headers })];
            });
        });
    };
    XAjaxClass.prototype.post = function (url, data, headers) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request({ url: url, data: data, method: HttpMethod.POST, headers: headers })];
            });
        });
    };
    XAjaxClass.prototype.patch = function (url, data, headers) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request({ url: url, data: data, method: HttpMethod.PATCH, headers: headers })];
            });
        });
    };
    XAjaxClass.prototype.put = function (url, data, headers) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request({ url: url, data: data, method: HttpMethod.PUT, headers: headers })];
            });
        });
    };
    XAjaxClass.prototype.delete = function (url, data, headers) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request({ url: url, data: data, method: HttpMethod.DELETE, headers: headers })];
            });
        });
    };
